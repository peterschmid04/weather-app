...
namespace weatherAPI.Migrations
{
    ...
    [Migration("20260527204418_AddUserThemePreferencesAndCrudEndpoints")]
    partial class AddUserThemePreferencesAndCrudEndpoints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("weatherAPI.Models.Database.UserThemePreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("weatherAPI.Models.Database.UserThemePreference", b =>
                {
                    b.HasOne("weatherAPI.Models.Database.UserProfile", "User")
                        .WithOne("ThemePreference")
                        .HasForeignKey("weatherAPI.Models.Database.UserThemePreference", "UserProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
