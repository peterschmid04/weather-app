...
AUTH0_CONNECTION_INSTAGRAM="$(prompt_value "AUTH0_CONNECTION_INSTAGRAM" "instagram")"
...
for pair in \
  ...
  "AUTH0_CONNECTION_INSTAGRAM=$AUTH0_CONNECTION_INSTAGRAM" \
...

{
  ...
  echo "AUTH0_CONNECTION_INSTAGRAM=$AUTH0_CONNECTION_INSTAGRAM"
  echo ""
